...
export default function Me() {
    return (
        <div className='flex flex-col gap-4'>
            <div className='flex w-full justify-between h-10'>
                <div className='flex items-center gap-3'>
                    <span className='h-10 w-10 overflow-hidden rounded-full bg-white'>
                        <img className="h-full w-full object-cover object-center" src='me.jpg' />
                    </span>
                    <span className='flex flex-col'>
                        <span className='text-base'>Sebastian Mastalerz</span>
                        <span className='text-sm text-gray-400'>Technik programista</span>
                    </span>
                </div>
            ...
            <div>
                <span className='text-base text-gray-400'>Absolwent technikum o profilu programista i student infromatyki. Specjalizuję się w front-endzie, ale posiadam również doświadczenie w back-endzie.</span>
            </div>
        </div>
    );
}